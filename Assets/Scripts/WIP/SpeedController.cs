...
namespace WIP
{
  ...
  {
    [SerializeField, ReadOnly, Tooltip("The current speed of the game [m/s]")] private float _speed;
    [SerializeField, ReadOnly, Tooltip("The current speed of the game [m/s]")] private float _acceleration;
